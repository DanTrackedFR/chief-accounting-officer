...
## Status
- REVIEWED / worked through this phase: 35
- BLOCKED: 0
- Remaining not yet worked through: 121
...
Continue TOPIC-05-007–010 share-based compensation/termination/compensation reconciliations, then bank/cash/FX, intercompany and primary financial reporting. Standards-heavy topics require current official-source verification and framework differences; operational topics receive principles/practice/controls/systems depth without artificial four-framework records.